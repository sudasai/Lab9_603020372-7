...
import com.myweb.lab9mysqlupdatedelete.EditStudentsAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler_view.addOnItemTouchListener(object : OnItemClickListener {
            override  fun  onItemClicked(position: Int, view: View) {
                ...
                val std :Student = studentList[position]
    ...
    fun clickSearch(v:View){
        ...
        createClient.retrieveStudentID(edt_search.text.toString())
            .enqueue(object : Callback<Student> {
                ...
                override  fun onFailure(call: Call<Student>, t: Throwable) :Unit = t.printStackTrace()
            })
    }
    ...
    fun callStudentData(){
        ...
        createClient.retrieveStudent()
            .enqueue(object : Callback<List<Student>> {
                ...
                override  fun onFailure(call: Call<List<Student>>, t: Throwable) :Unit = t.printStackTrace()
            })
    }
